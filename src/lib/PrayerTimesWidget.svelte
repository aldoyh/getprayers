...
<div class="glass-card p-8 islamic-pattern">
	...
	{:else}
		...
		{#if nextPrayer}
			...
			>
				<div class="absolute inset-0 bg-gradient-to-l from-[#d4af37]/10 to-transparent"></div>
		...
		<div class="grid grid-cols-2 md:grid-cols-3 gap-4">
			{#each prayers as prayer, i (prayer.name)}
				...
				>
					<h3 class="font-bold text-xl mb-2 {i === currentPrayerIndex ? 'text-[#d4af37]' : 'text-[#f0f0f5]'}">
						{prayer.nameAr}
					</h3>
