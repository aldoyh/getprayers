...
<div class="glass-card p-5 md:p-8 islamic-pattern">
	...
	{:else if verse}
		<div class="relative" in:scale={{ duration: 500, easing: quintOut }}>
			...
			<div
				class="absolute inset-0 bg-gradient-to-l from-[#d4af37]/10 via-transparent to-[#10b981]/5 rounded-2xl"
			/>
			<div class="absolute inset-0 islamic-pattern opacity-30 rounded-2xl" />

			<!-- Main Verse Card -->
			<div
				class="relative glass-card-gold p-5 md:p-8 md:p-10 border border-[#d4af37]/30 rounded-2xl"
			>
				<!-- Bismillah Decoration -->
				<div class="flex justify-center mb-6" in:fade={{ delay: 200, duration: 400 }}>
					<div
						class="w-24 h-1 bg-gradient-to-l from-transparent via-[#d4af37] to-transparent rounded-full"
					/>
				</div>
				...
				<div class="text-center mb-8" in:fly={{ y: 20, delay: 300, duration: 500 }}>
					<p
						class="text-2xl md:text-4xl lg:text-5xl text-[#d4af37] font-bold leading-loose mb-4 text-glow-gold quran-text"
					>
						﴿ {verse.text} ﴾
					</p>
				</div>
