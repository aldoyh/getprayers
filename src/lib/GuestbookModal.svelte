		...
		>
			{#if success}
				...
				<div class="text-center py-8" transition:fade>
					<div
						class="w-20 h-20 mx-auto mb-6 rounded-full bg-[#10b981]/20 flex items-center justify-center"
					>
						<svg
							class="w-10 h-10 text-[#10b981]"
							fill="none"
							viewBox="0 0 24 24"
							stroke="currentColor"
						>
			...
			{:else}
				...
				<div class="text-center mb-8">
					<div
						class="w-16 h-16 mx-auto mb-4 rounded-full bg-[#d4af37]/20 flex items-center justify-center"
					>
						<svg
